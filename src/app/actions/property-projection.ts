...
const ProjectionSchema = z.object({
  ...
  pessimisticGross: num.default(0),
  realisticGross: num.default(0),
  optimisticGross: num.default(0),
...
export async function upsertPropertyProjectionAction(
  ...
  const parsed = ProjectionSchema.safeParse({
    ...
    pessimisticGross: formData.get("pessimisticGross") || 0,
    realisticGross: formData.get("realisticGross") || 0,
    optimisticGross: formData.get("optimisticGross") || 0,
  ...
  const data = {
    ...
    pessimisticGross: v.pessimisticGross,
    realisticGross: v.realisticGross,
    optimisticGross: v.optimisticGross,
